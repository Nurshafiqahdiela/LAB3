...
import 'package:cakeshop/adminproduct.dart';
import 'package:cakeshop/user.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  String server = "https://saujanaeclipse.com/cakeshop";
  ...
  void initState() {
    ...
    _loadData();
    _loadCartQuantity();
    if (widget.user.email == "admin@cakeshop.com") {
      _isadmin = true;
    }
  }
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Column(
                                  children: <Widget>[
                                    FlatButton(
                                        onPressed: () => _sortItem("Vanila Cakes"),
                                        color:
                                            Color.fromRGBO(101, 255, 218, 50),
                                        padding: EdgeInsets.all(10.0),
                                        child: Column(
                                ...
                                Column(
                                  children: <Widget>[
                                    FlatButton(
                                        onPressed: () => _sortItem("Icecream Cakes"),
                                        color:
                                            Color.fromRGBO(101, 255, 218, 50),
                                        padding: EdgeInsets.all(10.0),
                                        child: Column(
                                ...
                                Column(
                                  children: <Widget>[
                                    FlatButton(
                                        onPressed: () => _sortItem("Indulgence Cakes"),
                                        color:
                                            Color.fromRGBO(101, 255, 218, 50),
                                        padding: EdgeInsets.all(10.0),
                                        child: Column(
                                ...
                                Column(
                                  children: <Widget>[
                                    FlatButton(
                                        onPressed: () => _sortItem("Blueberry Cakes"),
                                        color:
                                            Color.fromRGBO(101, 255, 218, 50),
                                        padding: EdgeInsets.all(10.0),
                                        child: Column(
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () async {
              if (widget.user.email == "unregistered") {
                ...
                return;
              } else if (widget.user.email == "admin@cakeshop.com") {
  ...
  _addtocartdialog(int index) {
    if (widget.user.email == "unregistered@cakeshop.com") {
      Toast.show("Please register to use this function", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
