...
import 'package:cakeshop/loginscreen.dart';
            ...
            Container(
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/images/splashcake.jpg'),
                        fit: BoxFit.fill))),
...
class _ProgressIndicatorState extends State<ProgressIndicator>
  ...
  void loginUser(String email, String pass, BuildContext ctx) {
    ...
    http.post("https://saujanaeclipse.com/cakeshop/php/login_user.php", body: {
      "email": email,
      "password": pass,
    })
      ...
      if (userdata[0] == "success") {
        ...
        loginUser("unregistered@cakeshop.com","123456789",ctx);
       }
    }).catchError((err) {
      print(err);
