...
import 'package:cakeshop/editproduct.dart';
import 'package:cakeshop/newproduct.dart';
import 'package:cakeshop/product.dart';
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Column(
                              children: <Widget>[
                                FlatButton(
                                    onPressed: () => _sortItem("Chocolate cakes"),
                                    color: Color.fromRGBO(101, 255, 218, 50),
                                    padding: EdgeInsets.all(10.0),
                                    child: Column(
                                      // Replace with a Row for horizontal icon + text
